...
# Update this to your DB file (SQLite) or replace with your DB URL (Postgres/MySQL).
# For this project, database is SQLite by default.
# Use the same DB file as init_db.py/main_enhanced.py (default elearning.db)
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('SQLALCHEMY_DATABASE_URI', 'sqlite:///elearning.db')
...
def view_course(course_id):
    ...
    html = render_template('course_detail.html',
...
# Alias endpoint for templates that refer to course_detail
app.add_url_rule('/course/<int:course_id>', endpoint='course_detail', view_func=view_course)
...
def delete_course(course_id):
    ...
    try:
        ...
        db.session.rollback()
        flash(f'Unable to delete this course: {exc}', 'danger')
